                    ...
                    if($_POST){
                        ...
                        if(isset($_POST["filter"])){
                            if($_POST["showonly"]=='all'){
                                ...
                                $sqlmain= "select * from booking inner join client on client.clientid=booking.clientid inner join schedule on schedule.scheduleid=booking.scheduleid where schedule.staffid=$userid;";
                                $selecttype="My";
                                $current="My clients Only";
                            }
                        }
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        <td> &nbsp;'.
                                        substr($clientname,0,35)
                                        .'</td>
                                        <td>
                                            '.substr($clienttel,0,10).'
                                        </td>
                                        <td>
                                        '.substr($clientemail,0,20).'
                                         </td>
                                        <td>
                                        '.substr($clientdob,0,10).'
                                        </td>
                                        <td >
                                        <div style="display:flex;justify-content: center;">
                                        
                                        <a href="?action=view&id='.$clientid.'" class="non-style-link"><button  class="btn-primary btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">View</font></button></a>
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                           ...
                           <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="client.php"><input type="button" value="OK" class="login-btn btn-primary btn" ></a>
