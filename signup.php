...
?>
    ...
    <div class="container">
        ...
        <td colspan="2">
            ...
            <tr>
                <td class="label-td">
                    <input type="text" name="fname" pattern = "[A-Za-z]*" class="input-text" placeholder="First Name" required>
                </td>
                <td class="label-td">
                    <input type="text" name="lname"pattern = "[A-Za-z]*" class="input-text" placeholder="Last Name" required>
                </td>
            </tr>
                        <tr>
                <td class="label-td" colspan="2">
