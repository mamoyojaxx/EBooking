...
<body>
    ...
    $sqlmain.="order by booking.appodate  asc";
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div class="h3-search">
                                                                    ...
                                                                    Reference Number: OC-000-'.$bookid.'
                                                                </div>
                                                                <div class="h1-search">
                                                                    '.substr($title,0,21).'<br>
                                                                </div>
                                                                <div class="h3-search">
                                                                    Appointment Number:<div class="h1-search">0'.$bookingnum.'</div>
                                                                </div>
                                                                <div class="h3-search">
                                                                    '.substr($staffname,0,30).'
                                                                </div>
                                                                ...
                                                                <br>
                                                                <a href="?action=drop&id='.$bookid.'&title='.$title.'&doc='.$staffname.'" ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Cancel Booking</font></button></a>
                                                        </div>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            ...
                            Staff name&nbsp; : <b>'.substr($staffname,0,40).'</b><br><br>
